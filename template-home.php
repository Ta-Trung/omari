...
get_header(); ?>
		...
		<div class="content-area">
			<main>
				<section class="slider">
					<div class="flexslider">
					  <ul class="slides">
						...
						?>
						    <li>
						      <?php the_post_thumbnail( 'omari-slider', array( 'class' => 'img-fluid' ) ); ?>
						      <div class="container">
				...
				<section id="slogan-text" class="py-5">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4 mb-4 text-center">
                                <h3>Lorem ipsum</h3>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis, excepturi.</p>
                            </div>
                            <div class="col-md-4 mb-4 text-center">
                                <h3>Lorem ipsum</h3>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis, excepturi.</p>
				...
				?>
						...
						<section class="popular-products text-center">
							<?php 
							...
							<div class="container">
								<div class="section-title">
									<h2><?php echo esc_html( get_theme_mod( 'set_popular_title', __( 'Popular products', 'omari' ) ) ); ?></h2>
								</div>
								<?php echo do_shortcode( '[products limit=" ' . esc_attr( $popular_limit ) . ' " columns=" ' . esc_attr( $popular_col ) . ' " orderby="popularity"]' ); ?>
							</div>
						</section>
						<section class="new-arrivals text-center">
							<div class="container">
								<div class="section-title">
									<h2><?php echo esc_html( get_theme_mod( 'set_new_arrivals_title', __( 'New Arrivals', 'omari' ) ) ); ?></h2>
								</div>
						...
						?>
						<section class="deal-of-the-week text-center">
							<div class="container">
								<div class="section-title">
									<h2><?php echo esc_html( get_theme_mod( 'set_deal_title', __( 'Deal of the Week', 'omari' ) ) ); ?></h2>
								</div>
								<div class="row d-flex align-items-center">
									...
									<div class="deal-desc col-md-4 col-12 mr-auto text-center">
										<?php if( !empty( $sale ) ): ?>
											<span class="discount">
												<?php echo esc_html( $discount_percentage ) . esc_html__( '% OFF', 'omari' ); ?>
											</span>
										<?php endif; ?>
										<h3>
										...
										<a href="<?php echo esc_url( '?add-to-cart=' . $deal ); ?>" class="add-to-cart"><?php esc_html_e( 'Add to Cart', 'omari' ); ?></a>
									</div>
								</div>
							</div>
						</section>
				...
				<section class="lab-blog text-center">
					<div class="container">
						<div class="section-title">
							<h2><?php echo esc_html( get_theme_mod( 'set_blog_title', __( 'News From Our Blog', 'omari' ) ) ); ?></h2>
						</div>						
						<div class="row">
							<?php 
												...
												<a href="<?php the_permalink(); ?>">
													<?php 
														if( has_post_thumbnail() ):
															the_post_thumbnail( 'omari-blog', array( 'class' => 'img-fluid' ) );
														endif;
													?>
												</a>
												<h3>
